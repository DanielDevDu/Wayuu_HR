...
class SocialSecurity(BaseModel):
    ...
    pension = models.CharField(max_length=100, default="pdf option?", blank=True)
    insurance = models.CharField(max_length=100,default="pdf option?", blank=True)
    ...
    file = models.FileField(verbose_name=_("Social Security pdf"), blank=True)
